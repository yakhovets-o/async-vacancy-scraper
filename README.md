...
* ```parser.py```
    ...
    *Модуль* занимается сбором  информации о вакансиях и сохраняет все в файл формата ```csv```.
...
*  ```models.py```
     ...
     *Модуль* создает, визуализирует и сохраняет  график в файл формата ```png```.
